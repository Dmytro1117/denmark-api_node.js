...
**Denmark API** is a contact management service that allows users to securely store and organize their contact lists. Users can create new contacts, manage their statuses, and upload profile pictures for both themselves and their contacts.
...
🔗 **[Live Swagger Documentation](https://denmark-api-backend-v92w.onrender.com/api-docs)**
