...
const verifycationLetter = ({ email, verificationToken }) => {
  const verifyUrl = `${BASE_FRONTEND_URL}/verify-email/${verificationToken}`;
  ...
  return {
    to: email,
    subject: "Activation Required — Denmark",
    html: `
<!DOCTYPE html>
<html>
<head>
                ...
                <tr>
                  <td style="padding:60px 40px;">
                    ...
                    <p style="color:#a1a1aa; font-size:16px; line-height:1.6; max-width:320px; margin:0 0 40px;">
                     Confirm your email to synchronize your profile with the Denmark site and activate your account.
                    </p>
